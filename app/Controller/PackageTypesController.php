 ...
 * City controller.
 *
 * This file will render views from views/PackageTypes/
 *
 * PHP 5
 *
...
class PackageTypesController extends AppController {
	...
	public function index() {
		...
		$this->set('PackageTypes', $this->paginate("PackageType", $search_condition));
	...
	public function add() {
		...
		$this->request->data['PackageType']['IsActive'] = '1';
