 ...
 * City controller.
 *
 * This file will render views from views/ServiceCostTargets/
 *
 * PHP 5
 *
 ...
 */
 ...
 /**
 * ServiceCostTargets controller
 *
 *
 * @package       app.Controller
 * @link http://book.cakephp.org/2.0/en/controllers/pages-controller.html
 */
class ServiceCostTargetsController extends AppController {
	var $uses = array('ServiceCostTarget');
	...
	public function index() {
		...
		$this->set('ServiceCostTargets', $this->paginate("ServiceCostTarget", $search_condition));
	...
	public function add() {
		...
		$this->request->data['ServiceCostTarget']['IsActive'] = '1';
		
		
		
        if ($this->request->is('post')) {

            $this->ServiceCostTarget->create();
            if ($this->ServiceCostTarget->save($this->request->data)) {
