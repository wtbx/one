 ...
 * City controller.
 *
 * This file will render views from views/ServiceScopes/
 *
 * PHP 5
 *
 ...
 */
 ...
 /**
 * ServiceScopes controller
 *
 *
 * @package       app.Controller
 * @link http://book.cakephp.org/2.0/en/controllers/pages-controller.html
 */
class ServiceScopesController extends AppController {
	var $uses = array('ServiceScope');
	...
	public function index() {
		...
		$this->set('ServiceScopes', $this->paginate("ServiceScope", $search_condition));
	...
	public function add() {
		...
		$this->request->data['ServiceScope']['IsActive'] = '1';
		
		
		
        if ($this->request->is('post')) {

            $this->ServiceScope->create();
            if ($this->ServiceScope->save($this->request->data)) {
