 ...
 * City controller.
 *
 * This file will render views from views/ServiceTands/
 *
 * PHP 5
 *
 ...
 */
 ...
 /**
 * ServiceTands controller
 *
 *
 * @package       app.Controller
 * @link http://book.cakephp.org/2.0/en/controllers/pages-controller.html
 */
class ServiceTandsController extends AppController {
	var $uses = array('ServiceTand');
	...
	public function index() {
		...
		$this->set('ServiceTands', $this->paginate("ServiceTand", $search_condition));
	...
	public function add() {
		...
		$this->request->data['ServiceTand']['IsActive'] = '1';
		
		
		
        if ($this->request->is('post')) {

            $this->ServiceTand->create();
            if ($this->ServiceTand->save($this->request->data)) {
