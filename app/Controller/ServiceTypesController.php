 ...
 * City controller.
 *
 * This file will render views from views/ServiceTypes/
 *
 * PHP 5
 *
...
class ServiceTypesController extends AppController {
	...
	public function index() {
		...
		$this->set('ServiceTypes', $this->paginate("ServiceType", $search_condition));
	...
	public function add() {
		...
		$this->request->data['ServiceType']['IsActive'] = '1';
