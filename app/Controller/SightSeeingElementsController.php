 ...
 * City controller.
 *
 * This file will render views from views/SightSeeingElements/
 *
 * PHP 5
 *
 ...
 */
class SightSeeingElementsController extends AppController {
	var $uses = array('SightSeeingElement');
	...
	public function index() {
		...
		$this->set('SightSeeingElements', $this->paginate("SightSeeingElement", $search_condition));
	...
	public function add() {
		...
		$this->request->data['SightSeeingElement']['IsActive'] = '1';
        ...
        if ($this->request->is('post')) {
            ...
            $this->SightSeeingElement->create();
            if ($this->SightSeeingElement->save($this->request->data)) {
