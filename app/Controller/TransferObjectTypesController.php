 ...
 * City controller.
 *
 * This file will render views from views/TransferObjectTypes/
 *
 * PHP 5
 *
 ...
 */
 ...
 /**
 * TransferObjectTypes controller
 *
 *
 * @package       app.Controller
 * @link http://book.cakephp.org/2.0/en/controllers/pages-controller.html
 */
class TransferObjectTypesController extends AppController {
	var $uses = array('TransferObjectType');
	...
	public function index() {
		...
		$this->set('TransferObjectTypes', $this->paginate("TransferObjectType", $search_condition));
	...
	public function add() {
        ...
        if ($this->request->is('post')) {
            ...
            $this->TransferObjectType->create();
            if ($this->TransferObjectType->save($this->request->data)) {
