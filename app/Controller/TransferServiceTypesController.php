 ...
 * City controller.
 *
 * This file will render views from views/TransferServiceTypes/
 *
 * PHP 5
 *
 ...
 */
 ...
 /**
 * TransferServiceTypes controller
 *
 *
 * @package       app.Controller
 * @link http://book.cakephp.org/2.0/en/controllers/pages-controller.html
 */
class TransferServiceTypesController extends AppController {
	var $uses = array('TransferServiceType');
	...
	public function index() {
		...
		$this->set('TransferServiceTypes', $this->paginate("TransferServiceType", $search_condition));
	...
	public function add() {
        ...
        if ($this->request->is('post')) {
            ...
            $this->TransferServiceType->create();
            if ($this->TransferServiceType->save($this->request->data)) {
