<?php
$this->Html->addCrumb('Edit Agent', 'javascript:void(0);', array('class' => 'breadcrumblast'));
$role_id = $this->Session->read("role_id");
if (($this->data['Agent']['agent_active_primary'] == '1' || $action_type == '0') && $role_id <> '38') {
    $active_primary = true;
...
if (($this->data['Agent']['agent_active_preference'] == '1' || $action_type == '1') && $role_id <> '38') {
    $active_preference= true;
    $label_active_preference = 'Waiting...';
} else {
    $active_preference = false;
    $label_active_preference = 'Update';
}
?>
<div class="col-sm-12"  id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body edtpro">
            <fieldset>
                <legend><span>Edit Agent</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php 
                    echo $this->Form->create('Agent', array('method' => 'post', 'id' => 'wizard_b', 'novalidate' => true,
    'inputDefaults' => array(
        'label' => false,
        'div' => false,
        'class' => 'form-control',
...
echo $this->Form->input('action_type', array('value' => '0', 'type' => 'hidden', 'id' => 'ActionType'));
                    ...
                    <fieldset class="nopdng">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php
                                            echo $this->Form->input('agent_suburb', array('options' => $suburbs, 'empty' => '--Select--', 'tabindex' => '5'));
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <?php
                                            echo $this->Form->input('agent_area', array('options' => $areas, 'empty' => '--Select--', 'tabindex' => '5'));
                                            ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="multicity" <?php if($this->data['Agent']['agent_multicity']){?>style="display: block;"<?php }else {?> style="display: none;"<?php }?>
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <?php
                                echo $this->Form->submit($label_active_primary, array('class' => 'btn btn-success sticky_success', 'disabled' => $active_primary));
                                ?>
                            </div>
                        </div>  
                    </fieldset>
                    ...
                    <fieldset class="nopdng">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <?php
                                echo $this->Form->submit($label_active_preference, array('class' => 'btn btn-success sticky_success', 'disabled' => $active_preference));
                                ?>
                            </div>
                        </div> 
                    </fieldset>
