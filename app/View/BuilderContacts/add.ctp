...
<div class="pop-outer">
    <div class="pop-up-hdng">Add Contact Details</div>
            ...
            <div class="col-sm-6">
                <?php if ($contact_type == '2') { ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"> <?php echo $this->Form->input('builder_contact_builder_id', array('empty' => '--Select--', 'options' => $builder, 'tabindex' => '1')); ?></div>
                    </div>
                <?php } elseif ($contact_type == '1') { ?>
                    <div class="form-group">
                        <label for="reg_input_name" class="req">Partner Name</label>
                        <span class="colon">:</span>
                        <div class="col-sm-10"> <?php echo $this->Form->input('builder_partner_id', array('empty' => '--Select--', 'options' => $partners)); ?></div>
                    </div>
                <?php } ?>
                <div class="form-group">
