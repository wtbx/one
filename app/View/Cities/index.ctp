    ...
    <div class="col-sm-12">
        <div class="table-heading">
            <h4 class="table-heading-title"><span class="badge badge-circle badge-success"> <?php
                    ...
                    ?></span> My Users</h4>
            <span class="badge badge-circle add-client nomrgn"><i class="icon-plus"></i> <?php echo $this->Html->link('Add City', '/cities/add') ?></span>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel_controls hideform">
                ...
                <?php
                echo $this->Form->create('City', array('controller' => 'Cities', 'action' => 'index', 'class' => 'quick_search', 'id' => 'SearchForm', 'novalidate' => true, 'inputDefaults' => array(
                        'label' => false,
                        'div' => false,
                        'class' => 'form-control',
                )));
...
<?php echo $this->Form->end(); ?>
            ...
            <table id="resp_table" class="table toggle-square" data-filter="#table_search" data-page-size="100">
                <thead>
                    <tr>
                        <th data-toggle="true">City Name</th>
...
if (isset($cities) && count($cities) > 0):
    foreach ($cities as $city):
        ...
        ?>
                            <tr>
                                <td><?php echo $city['City']['city_name']; ?></td>                     
...
<?php endif; ?>
            ...
            <span class="badge badge-circle add-client"><i class="icon-plus"></i> <?php echo $this->Html->link('Add City', '/cities/add') ?></span>
