...
<?php
$this->Html->addCrumb('Add Consultant', 'javascript:void(0);', array('class' => 'breadcrumblast'));
?>
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>Add Consultant</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    echo $this->Form->create('Consultant', array('method' => 'post', 'id' => 'wizard_a', 'novalidate' => true,
                        'inputDefaults' => array(
                            'label' => false,
                            'div' => false,
                            'class' => 'form-control',
                                ...
                                <div class="row form-wrap">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="colon">:</span>
                                            <div class="col-sm-10"> <?php echo $this->Form->input('consultant_text', array('class' => 'form-control consultant_text', 'readonly' => 'readonly')); ?></div>
                                        </div>
                                        <div class="form-group">
