<?php
$this->Html->addCrumb('View Consultant', 'javascript:void(0);', array('class' => 'breadcrumblast'));
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>View  Consultant</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    echo $this->Form->create('Consultant', array('method' => 'post', 'class' => 'form-horizontal user_form', 'id' => 'consultant',
                        'inputDefaults' => array(
                            'label' => false,
                            'div' => false,
                            'class' => 'form-control',
                    ...
                    if ($this->data['Consultant']['consultant_approved'] == 1)
                        $approved = 'Approved';
                    else
                        $approved = 'Pending';
                    ?>
                    <div class="col-sm-6">    
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php
                                    echo $this->Html->link($this->data['Consultant']['consultant_website'], $this->data['Consultant']['consultant_website'], array('target' => '_blank', 'escape' => false));
                                    $this->data['Consultant']['consultant_website'];
                                    ?></p>
                        ...
                        <div class="form-group slt-sm">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['BoardNumber']['code'] . ' ' . $this->data['Consultant']['consultant_boardnumber']; ?></p>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_name']; ?></p>
                        ...
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_boardemail']; ?></p>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 editable txtbox">
                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_corporateaddress']; ?></p>
                        ...
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable txtbox">
                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_description']; ?></p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <span class="colon">:</span>
                                                            <div class="col-sm-10"> <?php echo $this->data['Consultant']['consultant_contact_name']; ?></div>
                                                        </div>
                                                        ...
                                                        <div class="form-group slt-sm">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                echo $this->data['Consultant']['consultant_contact_mobile_no'];
                                                                ?></div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <span class="colon">:</span>
                                                            <div class="col-sm-10">  <?php echo $this->data['Consultant']['consultant_contact_email']; ?></div>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <?php
                                                                echo $this->data['Consultant']['consultant_contact_designation'];
                                                                ?></div>
                                                        </div>
                                                        <div class="form-group slt-sm">
                                                            ...
                                                            <div class="col-sm-10">  <?php
                                                                ...
                                                                echo $this->data['Consultant']['consultant_contact_secondary_mobile_no'];
                                                                ?></div>
                                                        </div>  
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title fpt">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#acc1_collapseThree">
                                                Consultant Multicity Operations
                                            </a>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title fpt">
                                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#acc1_collapseFour">
                                                Consultant Construction Capabilities
                                            </a>
                                        </h4>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <div class="col-sm-4 col-xs-12 editable">
                                                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_rating'] . ' -> ' . rating_range($this->data['Consultant']['consultant_rating']); ?></p>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <div class="col-sm-4 col-xs-12 editable">
                                                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_brandrecognition'] . ' -> ' . rating_range($this->data['Consultant']['consultant_brandrecognition']); ?></p>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <div class="col-sm-4 col-xs-12 editable">
                                                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_qualityofconstruction'] . ' -> ' . rating_range($this->data['Consultant']['consultant_qualityofconstruction']); ?></p>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <div class="col-sm-4 col-xs-12 editable">
                                                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_timelydelivery'] . ' -> ' . rating_range($this->data['Consultant']['consultant_timelydelivery']); ?></p>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <div class="col-sm-4 col-xs-12 editable">
                                                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_pasttrackrecord'] . ' -> ' . rating_range($this->data['Consultant']['consultant_pasttrackrecord']); ?></p>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="form-group">
                                                            <div class="col-sm-4 col-xs-12 editable">
                                                                <p class="form-control-static"><?php echo $this->data['Consultant']['consultant_professionalismandtransparency'] . ' -> ' . rating_range($this->data['Consultant']['consultant_professionalismandtransparency']); ?></p>
