        ...
        <div class="col-md-4 <?php if($cur_page == '1' || $cur_page == '10'){?>active<?php }?>">
         ...
         <div class="col-md-4 <?php if($cur_page == '3'){?>active<?php }?>">
    			...
    			<div class="info-box  bg-info  text-white" id="initial-tour">
    				...
    				<div class="info-details">
    					 <?php echo $this->Html->link('<h4>Reimbursement Actions<span class="pull-right">'.$project_action_pending.'</span></h4>', '/action-items/3', array('data-toggle' => 'tooltip','data-placement' => 'right','title' => 'My Builders','escape' => false));
...
<div class="row">
		...
		<div class="col-md-4 <?php if($cur_page == '1' || $cur_page == '10'){?>active<?php }?>">
    			...
    			<div class="info-box  bg-info  text-white" id="initial-tour">
    				...
    				<div class="info-details">
    					 <?php echo $this->Html->link('<h4>Commission Action<span class="pull-right">'.$client_allaction_pending.'</span></h4>', '/action-items', array('data-toggle' => 'tooltip','data-placement' => 'right','title' => 'My Builders','escape' => false));
        ...
        <div class="col-md-4">
    			...
    			<div class="info-box  bg-info  text-white" id="initial-tour">
    				...
    				<div class="info-details">
    					 <?php echo $this->Html->link('<h4>Tax Actions<span class="pull-right">0</span></h4>', '/action-items', array('data-toggle' => 'tooltip','data-placement' => 'right','title' => 'My Builders','escape' => false));
