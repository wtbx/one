<?php 
 ...
 ?>
	<div class="row">
        ...
        <div class="col-md-4 <?php if($cur_page == 'Reimbursements'){?>active<?php }?>">
    			...
    			<div class="info-box  bg-info  text-white" id="initial-tour">
    				...
    				<div class="info-details">
    					 <?php echo $this->Html->link('<h4>Reimbursements<span class="pull-right">'.$all_count.'</span></h4>', '/Reimbursements', array('data-toggle' => 'tooltip','data-placement' => 'right','title' => 'Reimbursement Payments','escape' => false));
    ...
    <div class="row">
        ...
        <div class="col-md-4">
    			...
    			<div class="info-box  bg-info  text-white" id="initial-tour">
    				...
    				<div class="info-details">
    					 <?php echo $this->Html->link('<h4>TAX Payments<span class="pull-right">0</span></h4>', '/payments', array('data-toggle' => 'tooltip','data-placement' => 'right','title' => 'My Builders','escape' => false));
        ...
        <div class="col-md-4">
    			...
    			<div class="info-box  bg-info  text-white" id="initial-tour">
    				...
    				<div class="info-details">
    					 <?php echo $this->Html->link('<h4>Invoice Payments<span class="pull-right">0</span></h4>', '/payments', array('data-toggle' => 'tooltip','data-placement' => 'right','title' => 'My Builders','escape' => false));
        ...
        <div class="col-md-4">
    			...
    			<div class="info-box  bg-info  text-white" id="initial-tour">
    				...
    				<div class="info-details">
    					 <?php echo $this->Html->link('<h4>Other Payments<span class="pull-right">0</span></h4>', '/payments', array('data-toggle' => 'tooltip','data-placement' => 'right','title' => 'My Builders','escape' => false));
