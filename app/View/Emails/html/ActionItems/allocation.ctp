...
<p>CREATED BY: <?php echo $CreatedBy;?></p>
<p>PHONE OFFICER: <?php echo $PhoneOfficer;?></p>
<p>ASSOCIATE: <?php echo $Associate;?></p>
<p>&nbsp;</p>
<p>CITY: <?php echo $City;?></p>
<p>URGENCY: <?php echo $Urgency;?></p>
<p>IMPORTANCE: <?php echo $Importance;?></p>
