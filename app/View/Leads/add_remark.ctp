...
<div class="pop-outer">
     <div class="pop-up-hdng">Add Remark</div>
	...
	echo $this->Form->create('Remark', array('method' => 'post','id' => 'parsley_reg','novalidate' => true,
											...
											array('controller' => 'leads','action' => 'add_remark')					
						));
   // pr($lead);
    ?>
    ...
    <div class="form-group" >
                <label for="input_name" class="req">Remark</label>
                <span class="colon">:</span>
                <div class="col-sm-10"><?php
                    echo $this->Form->input('remarks',array('type' => 'textarea','data-required' => 'true'));
                    ?>
