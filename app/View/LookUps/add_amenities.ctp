...
varCount++;
$node = '<div class="col-sm-10"><input type="text" class="form-control add" data-required="true" name="data[LookupValueAmenitie][amenity_name][]" id="var'+varCount+'"><span class="removeVar" style="display: inline-block;height: 14px;margin: 10px 0 0 10px;text-indent: -9999em;vertical-align: middle;width: 14px;background: url(../../img/remove-icon.png) no-repeat 0 0;">Remove Variable</span></div>';
