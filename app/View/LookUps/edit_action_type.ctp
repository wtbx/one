<div align="left" valign="top" class="headerText">Edit Action Type</div>
<?php echo $this->Session->flash(); ?>
<div class="content">
    <div class="tableheadbg">
        <div style="padding: 14px 30px; font-weight: bold;" >View Information</div>
    </div>
   <?php echo $this->Form->create('ActionItemType');?>
        ...
        <div class="popup_left">
            <div class="div_line">
                    ...
                    <div class="input_div">	<?php
                        echo $this->Form->input('type', array('div' => true,'label' => false,'class' => 'inputbox', 'size' => '25', 'maxlength' => '100'));
                        ?>
                    </div>
	    </div>
