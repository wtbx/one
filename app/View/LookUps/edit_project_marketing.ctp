<div align="left" valign="top" class="headerText">Edit Project Marketing</div>
        ...
        <div class="popup_left">
            <div class="div_line">
                    ...
                    <div class="input_div">	<?php
                        echo $this->Form->input('name', array('div' => true,'label' => false,'class' => 'inputbox', 'size' => '25', 'maxlength' => '100'));
                        ?>
                    </div>
	    </div>
