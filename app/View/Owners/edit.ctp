<?php
$this->Html->addCrumb('Edit Owner', 'javascript:void(0);', array('class' => 'breadcrumblast'));

$role_id = $this->Session->read("role_id");
if (($this->data['Owner']['owner_active_primary'] == '1' || $action_type == '0') && $role_id <> '27') {
    $owner_active_primary = true;
    $label_active_primary = 'Waiting...';
} else {
    $owner_active_primary = false;
    $label_active_primary = 'Update';
}

if (($this->data['Owner']['owner_active_operation'] == '1' || $action_type == '1') && $role_id <> '27') {
    $owner_active_operation = true;
    $label_active_operation = 'Waiting...';
} else {
    $owner_active_operation = false;
    $label_active_operation = 'Update';
}
if (($this->data['Owner']['owner_active_contact'] == '1' || $action_type == '2') && $role_id <> '27') {
    $owner_active_contact = true;
    $label_active_contact = 'Waiting...';
} else {
    $owner_active_contact = false;
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body edtpro">
            <fieldset>
                <legend><span>Edit Owner</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    echo $this->Form->create('Owner', array('method' => 'post', 'id' => 'wizard_b', 'novalidate' => true,
                        'inputDefaults' => array(
                            'label' => false,
                            'div' => false,
                            'class' => 'form-control',
                    ...
                    <fieldset class="nopdng">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <?php
                                echo $this->Form->submit($label_active_primary, array('class' => 'btn btn-success sticky_success', 'disabled' => $owner_active_primary));
                                ?>
                    ...
                    <fieldset class="nopdng">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <?php
                                echo $this->Form->submit($label_active_operation, array('class' => 'btn btn-success sticky_success', 'disabled' => $owner_active_operation));
                                ?>
                                <!--<button type="submit" id="update_buttn" disabled="disabled" class="btn btn-success sticky_success">Update</button>-->
                    ...
                    <fieldset class="nopdng">
                                ...
                                <div class="row form-wrap">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="colon">:</span>
                                            <div class="col-sm-10"> <?php echo $this->Form->input('owner_text', array('class' => 'form-control owner_text', 'value' => $this->data['Owner']['owner_name'], 'readonly' => 'readonly')); ?></div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <?php
                                echo $this->Form->submit($label_active_contact, array('class' => 'btn btn-success sticky_success', 'disabled' => $owner_active_contact));
                                ?>
                                <!--<button type="submit" id="update_buttn" disabled="disabled" class="btn btn-success sticky_success">Update</button>-->
