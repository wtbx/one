<?php
$this->Html->addCrumb('Add Package Type External', 'javascript:void(0);', array('class' => 'breadcrumblast'));
echo $this->Form->create('PackageTypeExternal', array('method' => 'post',
    'id' => 'parsley_reg',
    'novalidate' => true,
    'inputDefaults' => array(
        'label' => false,
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>Add Package Type External</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-6">
