<?php $this->Html->addCrumb('My Package Type Internals', 'javascript:void(0);', array('class' => 'breadcrumblast')); ?>
<div class="row">
    <div class="col-sm-12">
        <div class="table-heading">
            <h4 class="table-heading-title"><span class="badge badge-circle badge-success"> <?php
                    echo $this->Paginator->counter(array('format' => '{:count}'));
                    ?></span> My Package Type Internals</h4>
            <span class="badge badge-circle add-client nomrgn"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Package Type Internal', '/package_type_internals/add') ?></span>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel_controls hideform">
                ...
                <?php
                echo $this->Form->create('PackageTypeInternal', array('class' => 'quick_search', 'id' => 'SearchForm', 'novalidate' => true, 'inputDefaults' => array(
                        'label' => false,
                        'div' => false,
                        'class' => 'form-control',
                )));
...
// echo $this->Form->button('Reset', array('type' => 'reset', 'class' => 'btn btn-default btn-sm"'));
           ...
           <table border="0" cellpadding="0" cellspacing="0" id="resp_table" class="table toggle-square myclitb" data-filter="#table_search" data-page-size="100">
                ...
                <tbody>
                    <?php
                    if (isset($PackageTypeInternals) && count($PackageTypeInternals) > 0):
                        foreach ($PackageTypeInternals as $PackageTypeInternal):
                            $id = $PackageTypeInternal['PackageTypeInternal']['id'];
                           
                            ?>
                            <tr>
                                <td><?php echo $PackageTypeInternal['PackageTypeInternal']['PackageTypeInternalCode']; ?></td>
                                <td><?php echo $PackageTypeInternal['PackageTypeInternal']['PackageTypeInternal']; ?></td>
                                <td><?php echo $PackageTypeInternal['PackageTypeInternal']['SeqNo']; ?></td>
                                <td><?php echo $PackageTypeInternal['PackageTypeInternal']['IsActive']; ?></td>
            ...
            <span class="badge badge-circle add-client"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Package Type Internal', '/package_type_internals/add') ?></span>
