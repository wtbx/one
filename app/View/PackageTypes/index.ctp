<?php $this->Html->addCrumb('My Package Types', 'javascript:void(0);', array('class' => 'breadcrumblast')); ?>
<div class="row">
    <div class="col-sm-12">
        <div class="table-heading">
            <h4 class="table-heading-title"><span class="badge badge-circle badge-success"> <?php
                    echo $this->Paginator->counter(array('format' => '{:count}'));
                    ?></span> My Package Types</h4>
            <span class="badge badge-circle add-client nomrgn"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Package Type', '/package_types/add') ?></span>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel_controls hideform">
                ...
                <?php
                echo $this->Form->create('PackageType', array('class' => 'quick_search', 'id' => 'SearchForm', 'novalidate' => true, 'inputDefaults' => array(
                        'label' => false,
                        'div' => false,
                        'class' => 'form-control',
                )));
...
// echo $this->Form->button('Reset', array('type' => 'reset', 'class' => 'btn btn-default btn-sm"'));
           ...
           <table border="0" cellpadding="0" cellspacing="0" id="resp_table" class="table toggle-square myclitb" data-filter="#table_search" data-page-size="100">
                <thead>
                      <tr>
                        <th data-toggle="phone" data-sort-ignore="true">PackageTypeCode</th>
                        <th data-toggle="phone" data-sort-ignore="true" >PackageType</th>
                ...
                <tbody>
                    <?php
                    if (isset($PackageTypes) && count($PackageTypes) > 0):
                        foreach ($PackageTypes as $PackageType):
                            $id = $PackageType['PackageType']['id'];
                           
                            ?>
                            <tr>
                                <td><?php echo $PackageType['PackageType']['PackageTypeCode']; ?></td>
                                <td><?php echo $PackageType['PackageType']['PackageType']; ?></td>
                                <td><?php echo $PackageType['PackageType']['SeqNo']; ?></td>
                                <td><?php echo $PackageType['PackageType']['IsActive']; ?></td>
            ...
            <span class="badge badge-circle add-client"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Package Type', '/package_types/add') ?></span>
