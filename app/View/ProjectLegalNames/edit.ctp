				   ...
				   echo $this->Form->input('builder_contact_mobile_no',  array('class' => 'form-control sm rgt','tabindex' => '6','data-required' => 'true'));
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group slt-sm">
                                                    ...
                                                    <span class="colon">:</span>
													<div class="col-sm-10">  <?php echo $this->Form->input('builder_contact_secondary_mobile_country_code', array('options' => $codes, 'default' => '76','empty' => '--Select--','tabindex' => '7'));
				   echo $this->Form->input('builder_contact_secondary_mobile_no',  array('class' => 'form-control sm rgt','tabindex' => '8')); ?></div>
												</div>  
