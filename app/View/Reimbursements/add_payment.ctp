...
echo $this->Form->create('Payment', array('method' => 'post',
										...
										array('controller' => 'reimbursements','action' => 'add_payment')								
								...
								<table class="table table-striped invoice_table">
									...
									//pr($Reimbursements);
										...
										<tr>
                                            ...
                                            <td align="right"><?php echo $Reimbursement['Reimbursement']['reimbursement_factor_1'];?></td>
                                            <td align="right"><?php echo $Reimbursement['Reimbursement']['reimbursement_factor_2'];?></td>
                                            <td align="right"><?php echo $Reimbursement['Reimbursement']['reimbursement_amount'];?></td>
                                            <td align="right"><?php echo $Reimbursement['Reimbursement']['reimbursement_approved_amount'];?></td>
                                            <td><?php echo $this->Form->input('reimbursement_released_amount',array('id' => 'reimbursement_released_amount_'.$i,'class' => 'form-control rgt','name' => 'data[Reimbursement]['.$j.'][reimbursement_released_amount]','onchange' => 'calculate()','value' => $Reimbursement['Reimbursement']['reimbursement_approved_amount']));?></td>
                                            <td><?php echo $this->Form->input('reimbursement_released_comment',array('id' => 'reimbursement_released_amount_'.$i,'class' => 'form-control','name' => 'data[Reimbursement]['.$j.'][reimbursement_released_comment]'));?></td>
										</tr>
									...
									<tfoot>
										<tr>
											...
											<td class="col_total" align="right"><strong class="sub_total"><?php echo 'INR '.sprintf('%0.2f', $subtotal);?></strong></td>
										</tr>
										...
										<tr class="grand_total">
											...
											<td class="col_total" align="right"><strong class="grand_total_amt"><?php echo 'INR '.sprintf('%0.2f', $subtotal);?></strong></td>
										</tr>
									</tfoot>
								</table>
							</div>
