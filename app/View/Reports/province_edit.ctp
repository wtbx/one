<?php
$this->Html->addCrumb('Edit Province', 'javascript:void(0);', array('class' => 'breadcrumblast'));
?>
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>Edit Province</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    echo $this->Form->create('Province', array('method' => 'post', 'id' => 'parsley_reg', 'class' => 'form-horizontal user_form', 'novalidate' => true,
                        ...
                        array('controller' => 'reports', 'action' => 'province_edit')
                    ));
