<?php
$this->Html->addCrumb('Edit Suburb', 'javascript:void(0);', array('class' => 'breadcrumblast'));
//pr($this->data);
?>
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>Edit Suburb</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    echo $this->Form->create('TravelSuburb', array('method' => 'post', 'id' => 'parsley_reg', 'class' => 'form-horizontal user_form', 'novalidate' => true,
                        ...
                        array('controller' => 'reports', 'action' => 'suburb_edit')
                    ));
...
<?php echo $this->Form->input('city_id', array('options' => $TravelCities, 'empty' => '--Select--', 'data-required' => 'true')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['TravelSuburb']['active']; ?></p>
                                <div class="hidden_control">
<?php echo $this->Form->input('active', array('options' => array('TRUE' => 'TRUE','FALSE' => 'FALSE'), 'empty' => '--Select--', 'data-required' => 'true')); ?>
                                </div>
                            </div>
                        </div>
                    </div>  
...
<?php echo $this->Form->input('continent_id', array('options' => $TravelLookupContinents, 'empty' => '--Select--', 'data-required' => 'true')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['TravelSuburb']['province_name']; ?></p>
                                <div class="hidden_control">
...
<?php echo $this->Form->input('top_neighborhood',array('options' => array('TRUE' => 'TRUE','FALSE' => 'FALSE'),'empty' => '--Select--')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['TravelSuburb']['status']; ?></p>
                                <div class="hidden_control">
<?php echo $this->Form->input('status',array('options' => array('1' => 'OK','2' => 'ERROR'),'empty' => '--Select--', 'data-required' => 'true')); ?>
                                </div>
                            </div>
                        </div>
...
$this->Js->get('#TravelSuburbProvinceId')->event('change', $this->Js->request(array(
            'controller' => 'all_functions',
