<?php
$this->Html->addCrumb('View / Edit Role', 'javascript:void(0);', array('class' => 'breadcrumblast'));

echo $this->Form->create('Role', array('method' => 'post', 'id' => 'parsley_reg',
    'novalidate' => true, 'class' => 'form-horizontal user_form',
    'inputDefaults' => array(
        'label' => false,
        'div' => false,
        'class' => 'form-control',
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>View / Edit Role</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">    
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['Role']['role_name']; ?></p>
                                <div class="hidden_control">
                                    <?php echo $this->Form->input('role_name',array('tabindex' => '1', 'data-required' => 'true')); ?>
                                </div>
                            </div>
                        </div>
                    </div>  
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 editable">
                                ...
                                <div class="hidden_control">
                                    <?php echo $this->Form->input('group_id', array('options' => $groupsusers,'tabindex' => '2','empty' => '--Select--')); ?>
                                </div>
                            </div>
                        </div>
                    </div>
