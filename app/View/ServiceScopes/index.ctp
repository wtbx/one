<?php $this->Html->addCrumb('My Service Scopes', 'javascript:void(0);', array('class' => 'breadcrumblast')); ?>
<div class="row">
    <div class="col-sm-12">
        <div class="table-heading">
            <h4 class="table-heading-title"><span class="badge badge-circle badge-success"> <?php
                    echo $this->Paginator->counter(array('format' => '{:count}'));
                    ?></span> My Service Scopes</h4>
            <span class="badge badge-circle add-client nomrgn"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Service Scope', '/service_scopes/add') ?></span>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel_controls hideform">
                ...
                <?php
                echo $this->Form->create('ServiceScope', array('class' => 'quick_search', 'id' => 'SearchForm', 'novalidate' => true, 'inputDefaults' => array(
                        'label' => false,
                        'div' => false,
                        'class' => 'form-control',
                )));
...
// echo $this->Form->button('Reset', array('type' => 'reset', 'class' => 'btn btn-default btn-sm"'));
           ...
           <table border="0" cellpadding="0" cellspacing="0" id="resp_table" class="table toggle-square myclitb" data-filter="#table_search" data-page-size="100">
                <thead>
                      <tr>
                        <th data-toggle="phone" data-sort-ignore="true">ServiceScope</th>
                        <th data-toggle="phone" data-sort-ignore="true" >ServiceScopeCode</th>                        
                        <th data-hide="phone" data-sort-ignore="true" >IsActive</th>                                             
                    </tr>
                </thead>
                <tbody>
                    <?php
                    if (isset($ServiceScopes) && count($ServiceScopes) > 0):
                        foreach ($ServiceScopes as $ServiceScope):
                            $id = $ServiceScope['ServiceScope']['id'];
                           
                            ?>
                            <tr>
                                <td><?php echo $ServiceScope['ServiceScope']['ServiceScope']; ?></td>
                                <td><?php echo $ServiceScope['ServiceScope']['ServiceScopeCode']; ?></td>                               
                                <td><?php echo $ServiceScope['ServiceScope']['IsActive']; ?></td>
            ...
            <span class="badge badge-circle add-client"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Service Scope', '/service_scopes/add') ?></span>
