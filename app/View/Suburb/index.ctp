...
<div class="row">
                ...
                ?></span> My Suburbs</h4>
                                        <span class="badge badge-circle add-client nomrgn"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Suburb','/suburb/add')?></span>
                    ...
                    ?> 
                        ...
                        <div class="col-sm-3 col-xs-4">
										...
										<tr>
											...
											<td><?php echo $suburb['City']['city_name']; ?></td>
												...
												<?php 
												 ...
												 echo $this->Html->link('<span class="icon-pencil"></span>', array('controller' => 'suburb','action' => 'edit','slug' => $suburb['Suburb']['suburb_name'].'-'.$suburb['City']['city_name'],'id' => base64_encode($id),'mode' => '1'), array('class' => 'act-ico','escape' => false));
                                             echo $this->Html->link('<span class="icon-eye-open"></span>', array('controller' => 'suburb','action' => 'edit','slug' => $suburb['Suburb']['suburb_name'].'-'.$suburb['City']['city_name'],'id' => base64_encode($id),'mode' => '2'), array('class' => 'act-ico','escape' => false));
                                    ...
                                    <span class="badge badge-circle add-client"><i class="icon-plus"></i> <?php echo $this->Html->link('Add Suburb','/suburb/add')?></span>
