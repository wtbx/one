                                        ...
                                        <div class="row">
                                        	<div class="col-sm-12">
                                                ...
                                                <div class="form-group">
													...
													<div class="col-sm-10">
													<?php
														 echo $this->Form->input('suburb_status',   array('options' => array('1' =>'Active','2' =>'Inactive'),'empty'=>'--Select--','data-required' => 'true'));
                                            	...
                                            	<div class="form-group">
													...
													<div class="col-sm-10">
													<?php
														 echo $this->Form->input('suburb_name',array('data-required' => 'true'));
                                                ...
                                                <div class="form-group">
													...
													<div class="col-sm-10">
													<?php
														echo $this->Form->input('suburb_rating',array('type' => 'text'));
												...
												<div class="form-group">
													...
													<div class="col-sm-10"><?php
														echo $this->Form->input('suburb_economicparameters',array('type' => 'text'));
                                                ...
                                                <div class="form-group">
													...
													<span class="colon">:</span>
													<div class="col-sm-10"><?php
														 echo $this->Form->input('suburb_politicalparameters',array('type' => 'text'));
                                                ...
                                                <div class="form-group">
													...
													<span class="colon">:</span>
													<div class="col-sm-10"><?php
														  echo $this->Form->input('suburb_populationparameter',array('type' => 'text'));
                                                ...
                                                <div class="form-group slt-sm">
													...
													<span class="colon">:</span>
													<div class="col-sm-10"><?php
														 echo $this->Form->input('suburb_investmentenvironment',array('type' => 'text'));
                                                ...
                                                <div class="form-group">
													...
													<span class="colon">:</span>
													<div class="col-sm-10"><?php
														 echo $this->Form->input('suburb_infrastructuregrowthpotential',array('type' => 'text'));
