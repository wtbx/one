<?php
$this->Html->addCrumb('Re-try Area', 'javascript:void(0);', array('class' => 'breadcrumblast'));
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>Re-try Area</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-6">
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10"><?php
                                echo $this->Form->input('area_active', array('options' => array('TRUE' => 'TRUE','FALSE' => 'FALSE'),'empty' => '--Select--', 'disabled' => 'true'));
                                ?></div>
                        </div>
