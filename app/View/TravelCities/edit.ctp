                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 editable">
                                ...
                                <div class="hidden_control">
                                    <?php echo $this->Form->input('city_code', array('readonly' => true)); ?>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 editable">
                                ...
                                <div class="hidden_control">
                                    <?php echo $this->Form->input('top_city', array('options' => array('TRUE' => 'TRUE', 'FALSE' => 'FALSE'), 'empty' => '--Select--')); ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 editable">
                            ...
                            <div class="hidden_control">
<?php echo $this->Form->input('city_description', array('type' => 'textarea','style' => 'width:122%;height:100px')); ?>
                            </div>
                        </div>
                    </div>
