<?php
$this->Html->addCrumb('Re-try Hotel', 'javascript:void(0);', array('class' => 'breadcrumblast'));
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">Re-try Hotel</h4>
        </div>
        <div class="panel-body">
            <fieldset>
                <legend><span>Re-try Hotel</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                     <div class="col-sm-6">
                    ...
                    <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10 editable txtbox">
                                            <?php
                                            echo $this->Form->input('hotel_comment', array('type' => 'textarea','readonly' => true));
                                            ?>
                                        </div>
                                    </div>
                                </div>
