<?php
$this->Html->addCrumb('View / Edit Continent', 'javascript:void(0);', array('class' => 'breadcrumblast'));
?>
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>View / Edit Continent</span></legend>
            </fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <?php
                    echo $this->Form->create('TravelLookupContinent', array('method' => 'post', 'id' => 'parsley_reg', 'class' => 'form-horizontal user_form', 'novalidate' => true,
                        'inputDefaults' => array(
                            'label' => false,
                            'div' => false,
                            'class' => 'form-control',
                    ...
                    <div class="col-sm-6"> 
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['TravelLookupContinent']['continent_name']; ?></p>
                                <div class="hidden_control">
                                    <?php echo $this->Form->input('continent_name', array('data-required' => 'true')); ?>
                                </div>
                            </div>
                        </div>                 
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <span class="colon">:</span>
                            <div class="col-sm-10 editable">
                                <p class="form-control-static"><?php echo $this->data['TravelLookupContinent']['continent_code']; ?></p>
                                <div class="hidden_control">
                                    <?php echo $this->Form->input('continent_code',array( 'data-required' => 'true')); ?>
                                </div>
                            </div>
                        </div>                        
                    </div>
