<?php
$this->Html->addCrumb('Activate / Deactivate Suburb', 'javascript:void(0);', array('class' => 'breadcrumblast'));
...
<div class="col-sm-12" id="mycl-det">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <fieldset>
                <legend><span>Activate / Deactivate Suburb</span></legend>
            </fieldset>
            <div class="row">
...
<script>
    $("#TravelSuburbActive").change(function(){
        $(".toggle").toggle();
    });
</script>