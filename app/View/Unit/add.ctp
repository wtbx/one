...
<div>
    <div class="tableheadbg">
        <span class="heading_text">Add Units For | <?php echo $project['Project']['project_name']; ?></span>
    </div>
    ...
    <div class="tableboeder popup_fr">
        ...
        <div class="popup_right">
            ...
            <div class="buttons">
                ...
                <?php echo $this->Form->submit('Add Unit', array('class' => 'updateBox','div' => false, 'id' => 'udate_unit')); ?>
