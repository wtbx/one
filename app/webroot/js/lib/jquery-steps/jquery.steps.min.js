...
"previous",b.labels.previous));c+=n('<li class="next_step"><a href="#{0}" class="btn btn-default" role="menuitem">{1}</a></li>',"next",b.labels.next);b.enableFinishButton&&(c+=n('<li class="last_step"><a href="#{0}" class="btn btn-success" role="menuitem" id=\"lead_add\">{1}</a></li>',"finish",b.labels.finish));a.append(n('<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',b.actionContainerTag,b.clearFixCssClass,b.labels.pagination,c));x(a,b,d);R(a,b,d)}}function F(a,b){for(var d=a.match(/#([a-z]*)#/gi),
