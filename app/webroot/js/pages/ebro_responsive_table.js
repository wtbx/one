	...
	ebro_responsive_table = {
		...
		init: function() {
			...
			if($('.responsive_table').length) { 
				...
				$('.responsive_table').footable().on('footable_filtering', function (e) {
				...
				$('#clear-filter').click(function (e) {
					...
					$('.responsive_table').trigger('footable_clear_filter');
				...
				$('#un_member').change(function (e) {
					...
					$('.responsive_table').trigger('footable_filter', {filter: $('#table_search').val()});
